                    ...
                    <div class="card-body">
                        ...
                        <label for="header_cover" class="custom-file-upload form-control">
                            <span class="upload_text">
                                <i class="fa fa-cloud-upload"></i>{{ $header_cover ? ' تعديل صورة الهيدر ' : ' رفع صورة الهيدر' }}
                            </span>
                        </label>
                        ...
                        <div class="col-md-12">
                            <div  style="width: 100%; margin: 0 auto">
                                <div class="form-inline" style="text-align: center">
                                    ...
                                    <span class="image_dimensions_asterisk">
                                        <strong>*</strong>
                                        يجب ان تكون ابعاد الصور [العرض : 370px , الطول : 390px ]
                                    </span>
                                    <br>
        ...
        Dropzone.options.myDropzoneForm = {
            ...
            init:function(){
                ...
                this.on("thumbnail", function (file) {
                    if (file.height != 390 || file.width != 370) {
                        alert("انتبة ابعاد الصور غير متطابقة [العرض : 370px , الطول : 390px ]");
                    }
                });
